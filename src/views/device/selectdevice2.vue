<template>
  <div class="container">
    ...
    <div class="part-box">
      <h3>选择设备</h3>
      <!-- 单选框组件 -->
      <radioPart03 :modleData="modleData" :flag="flag"></radioPart03>
...
<script>
import radioPart03 from "@/components/radioPart03";
...
export default {
  data() {
    return {
      ...
      query: {
        ...
        //设备还是配件
        "b.status_equal": this.status,
        //对应项目
        "g.projectId_equal": this.projectId,
        //过滤掉已经选的设备或者配件
        // "a.id_notin": this.notInIds 由于需求原因不进行过滤
      },
      ids: ""
    };
  },
  ...
  props: ["projectId", "status", "notInIds"],
  created() {
