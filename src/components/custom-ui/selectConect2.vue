...
export default {
  ...
  created () {
    selectCustomerList(undefined,undefined,'design').then(res => {
  ...
  methods: {
    setValues (customerId, projectId) {
      ...
      if (this.form.customerId) {
        selectOrderProjectList(this.form.customerId,'design').then(res => {
    ...
    changeCustomer (value) {
      // selectOrderProjectList(value,'design').then(res => {
      //   this.selectDataProject = res.data.data
      // });
      var customer ={};
